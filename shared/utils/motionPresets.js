...
// ALD 16/06/2026 - ĐÃ BỎ 1080p + 60fps (theo yêu cầu). Cấu hình: 5s/10s/15s 720p + 10s-480p (nhanh, distill)
...
export const MOTION_PRESETS = [
  { id: '5s-720p',    label: '5s · 720p',          resolution: '720x1280', frames: 81,  steps: 4,  eta: '1-2 min',  maxFps: 30, note: 'Đoạn ngắn 5s' },
